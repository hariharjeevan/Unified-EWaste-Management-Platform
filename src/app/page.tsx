      ...
      <main className="p-6 flex flex-col items-center flex-grow">
        <div className="max-w-4xl text-center mb-2 flex flex-col items-center justify-center relative z-10">
          <div className="md:w-2/3">
            <h1 className="text-4xl font-extrabold text-green-500 mb-4 relative z-10">
        ...
        <div id="links-section" className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-4xl relative mt-8 z-10">
          <button
            onClick={() => handleLinkClick("Manufacturer", "/manufacturer")}
            className="bg-blue-500 p-8 w-[280px] rounded-lg text-center shadow-md transition-transform transform hover:scale-105 border border-[#000500]"
          >
          ...
          <button
            ...
            className="bg-green-500 p-8 w-[280px] rounded-lg text-center shadow-md transition-transform transform hover:scale-105 border border-[#000500]"
          >
            <div className="flex justify-center mb-2">
          ...
          <button
            ...
            className="bg-yellow-500 p-8 w-[280px] rounded-lg text-center shadow-md transition-transform transform hover:scale-105 border border-[#000500]"
          >
            <div className="flex justify-center mb-2">
