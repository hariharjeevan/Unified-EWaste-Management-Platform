  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#f5f3f4]">
      ...
      <main className="p-6 flex flex-col items-center flex-grow">
        ...
        <div className="bg-[#ffffff] shadow-md rounded-lg p-6 max-w-4xl mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-4xl">
          <Link
            href="/login"
            className="bg-blue-500 p-6 rounded-lg text-center shadow-md transition-transform transform hover:scale-105 border border-[#000500]"
          >
          ...
          <Link
            href="/recycler"
            className="bg-green-500 p-6 rounded-lg text-center shadow-md transition-transform transform hover:scale-105 border border-[#000500]"
          >
          ...
          <Link
            href="/consumer"
            className="bg-yellow-500 p-6 rounded-lg text-center shadow-md transition-transform transform hover:scale-105 border border-[#000500]"
          >
